...
from inpaint_ops import conv2d_spectral_norm, gan_hinge_loss
...
class InpaintCAModel(Model):
    ...
    def build_graph_with_losses(self, batch_data, config, training=True,
        ...
        #losses['l1_loss'] = tf.losses.absolute_difference(batch_pos, batch_complete)
        ...
        if config.GAN == 'sn_patch_gan':
            ...
            losses['g_loss'] += losses['l1_loss'] # l1_loss:g_loss = 1:1
